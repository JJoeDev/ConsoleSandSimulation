...
void particleDraw(Map& map, int& x, int& y) {
    ...
    case _EMPTY:
        ...
        break;
    case _PLAYER:
        printf("\033[1;47mP\033[0m");
        break;
    case _SAND:
        printf("\033[1;43mS\033[0m");
        particleUpdate(map, x, y);
        break;
    case _BRICK:
        printf("\033[1;41mB\033[0m");
        break;
    }
}
...
int main(void) {
    ...
    RECT win{ 450, 100, 100, 770 }; // W 450, X 100, Y 100, H 770
    MoveWindow(hwnd, win.right, win.top, win.left, win.bottom, TRUE);
